...
public class Race{
    ...
    Car car1 = new Car("Porsche 911", rand.nextInt(50) + 1, rand.nextInt(10) + 1, false,0);
    Car car2 = new Car("BMW M5",rand.nextInt(50) + 1, rand.nextInt(10) + 1, false,0);
    Car car3 = new Car("Aston Martin DB 11",rand.nextInt(50) + 1, rand.nextInt(10) + 1, false,0);
    Car car4 = new Car("Volga",rand.nextInt(50) + 1, rand.nextInt(10) + 1, false,0);
    Car car5 = new Car("Suzuki Swift Sport",rand.nextInt(50) + 1, rand.nextInt(10) + 1, false,0);
